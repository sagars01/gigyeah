        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-10 md:pb-16">
            <h1 className="text-6xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400"> Instantly</span> </h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">
                Command AI to source and secure talent effortlessly
              </p>
